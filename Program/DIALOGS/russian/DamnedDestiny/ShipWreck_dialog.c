...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "4":
			dialog.text = "Понимаете, капитан. Мы могли бы уплыть с вами - я думаю места на вашем корабле хватило бы. Но дело в том, что в трюме моего корабля находиться груз, который я должен доставить по назначению. Я не хочу слишком утруждать, но я прошу вас лишь взять моего человека и высадить на ближайшей колонии...";
			link.l1 = "Конечно.";
			link.l1.go = "YesYes";
