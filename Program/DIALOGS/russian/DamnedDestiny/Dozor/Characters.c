...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Fisher_Pedro_7":
			dialog.text = "Ах ты! Ах ты, жадная скотина! Проклятый зажравшийся ублюдок! Убирайся! ...(хныкая)... Убирайся!";
		...
		case "Spanch_Bob_2":
			dialog.text = "А-а! Дозорим, мой друг?";
			link.l1 = "Да вот решил ввязаться, попробовать.";
			link.l1.go = "Spanch_Bob_3";
		break;
		
		case "Spanch_Bob_3":
			dialog.text = "И правильно решил! Помниться я тоже в эту игру играл, славные были деньки. Давненько это было. Да только всё время не везло нашей команде. То мачта сломается, то на мель сядем, то ещё какая-нибудь пакость приключиться.";
			link.l1 = "А что и раньше такие игры проводились?";
			link.l1.go = "Spanch_Bob_4";
		break;
		
		case "Spanch_Bob_4":
			dialog.text = "Конечно! А ты разве не знал?";
			link.l1 = "Не знал, я впервые слышу об этом.";
			link.l1.go = "Spanch_Bob_5";
		break;
		
		case "Spanch_Bob_5":
			dialog.text = "Эх, деревня ты, кэп. Ну ладно, удачи тебе разга... И-ик! В общем, прощавай, брат!";
		...
		case "Spanch_Bob_7":
			dialog.text = "А-а, это бесполезный кусок... железа. Прости, братуха, пропил я его на днях.";
			link.l1 = "Что?! Пропил? Совсем с катушек съехал, развалина пьяная? Я как, по-твоему, игру продолжать должен, а?!";
			link.l1.go = "Spanch_Bob_8";
		break;
		
		case "Spanch_Bob_8":
			dialog.text = "Да не кипятись ты так!";
			link.l1 = "Я 20 штук отвалил за игру! Да я тебе сейчас глотку перережу, свинья!";
		...
		case "Justin_Butt_1":
			dialog.text = "Ты победил, победил! Забери Мекахром из сундука, только оставь меня в покое!";
		...
		case "Justin_Butt_2":
			...
			link.l1 = "Это часть задания? Суть в том, что я должен был боем взять Мекахром?";
		...
		case "Justin_Butt_5":
			dialog.text = "Да! По-твоему лицу видать, что ты впервые слышишь об этом. Что же раз уж ты победил меня в честном бою, расскажу тебе. Понимаешь, ты не один в этой игре, помимо тебя и меня, есть ещё три капитана, которые играют в Дозор. \n Этот старик, организатор игры, предложил сыграть в эту игру всем капитанам, которые бросали якорь на Бермудах, пока он был там. И пять из них согласились.";
		...
		case "Justin_Butt_8":
			...
			link.l1 = "А как же Теркс? Я нашёл там лишь один Мекахром - у бандитов, которые, по-видимому, убили агента.";
			link.l1.go = "Justin_Butt_9";
		break;
		
		case "Justin_Butt_9":
			dialog.text = "Чего не знаю, того не знаю. Я уступал тебе тогда, приехал на Теркс после тебя и обнаружил несколько трупов. Один из них, судя по всему, и был агентом, а двое других смахивали на бандитов, которых как я понял сейчас, завалил ты. Я нашёл предназначавшиеся нам Мекахромы спрятанными в пещере.";
			link.l1 = "А Мейн? Откуда ты узнал, что я опережаю тебе на два дня?";
		...
		case "Justin_Butt_10":
			...
			link.l1 = "То есть после того, как я нашёл Мекахром, он положил новый, чтобы ты его нашёл?";
		...
		// НЕЗНАКОМЕЦ В ДОМЕ -->
		case "NoName_1":
			dialog.text = "Ты первый, кто добрался до сокровища, дозорный. Поздравляю!";
		...
		case "NoName_5":
			...
			link.l1 = "Я к этому бы точно не стремился.";
			link.l1.go = "NoName_6";
		break;
		...
		case "NoName_8":
			dialog.text = "Точно. Тебе, как первому прибывшему, полагается самый богатый клад - 3 ценных вещи и 100.000 золотых, которые с лихвой покроют твои расходы. Второму прибывшему полагался клад, который содержит 1 ценную вещь и покроет издержки на игру. \n Третьему мы возвращали взнос за игру, а остальные должны были уйти ни с чем. Но так как никто кроме тебя не придёт, то моя задача выполнена.";
		...
		case "NoName_9":
			...
			link.l1 = "Странно, но до того как Фабиан предложил мне сыграть, я никогда не слышал о Дозоре.";
			link.l1.go = "NoName_10";
		break;
		
		case "NoName_10":
			dialog.text = "А слышать ты вряд ли мог. К концу игры, как правило, выживал лишь один капитан. Я же говорю, они стремятся уничтожить друг-друга - не умеют играть честно. Поэтому вы не знали, вернее не должны были знать о существовании друг-друга. Как видишь, опять ничего не вышло - в живых остался только один ты. ";
