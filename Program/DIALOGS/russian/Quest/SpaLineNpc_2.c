...
//*************************** Квест №2, диалоги с Франциско на выходе из Инквизиии ***************************
		...
		break;
 		case "Step_S2_9":
			dialog.text = "Не худший вариант в моем нынешнем положении. Спасибо, что не убил"+ GetSexPhrase("","а") +" меня.";
		...
		break;
 		case "Step_S2_19":
			...
			link.l1 = "Защита христианских реликвий - святой долг каждого истинного католика... Но я еще ничего не решил"+ GetSexPhrase("","а") +", посмотрим по обстоятельствам.";
