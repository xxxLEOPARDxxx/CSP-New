...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            {
    			dialog.text = "Ты победил"+ GetSexPhrase("","а") +"! Я сдаюсь...";
			...
			if (pchar.questTemp.State == "SeekBible_WeWon" && npchar.id == "LoranDeGraf")// Лоран де Граф, квест №8
            {
    			...
    			link.l1 = "Знаю, я как раз искал"+ GetSexPhrase("","а") +" встречи с вами сначала на Бермудах, затем на Тортуге.";
...
//********************************* Диалоги кэпа, который увез де Барраса из Тортуги **********************************
		...
		break;
  		case "Step_H7_3":
			dialog.text = "Не твое собачье дело, каррамба...\n"+
                          "Хей, вы как нельзя вовремя, ребята! Валим "+ GetSexPhrase("этого пижона, надоел","эту мерзавку, надоела") +" он мне...";
			link.l1 = "Аргх...";
		...
		case "Step_H8_10":
			...
			link.l1 = "Меня зовут " + GetFullName(pchar) + ", я хотел"+ GetSexPhrase("","а") +" бы купить у вас книгу, которую вы предлагали к продаже в обществе Джекмена.";
		...
		case "Step_H8_14":
			...
			link.l1 = "Это точно. Я благодар"+ GetSexPhrase("ен","на") +" вам, Лоран де Граф. Надеюсь, еще увидимся.";
			link.l1.go = "exit";
