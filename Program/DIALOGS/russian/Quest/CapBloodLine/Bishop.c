...
//            SetCharacterGoods(Pchar,GOOD_RUM,40);//600);
        ...
        case "DKStep_6":
            ...
            dialog.text = "Если честно, я даже не знаю что делать... Я хотел оставить море, осесть на суше, найти достуйную жену и зажить спокойной жизнь. Теперь в Англию возврата нет, с Испанией и Голландией та же ситуация, остаеться только Франция, но там нет ничего, что держало бы меня, никого, кто помог бы выжить в этом жестоком мире.\nНа плантациях же я успел подружиться с тобой, Питтом и другими невольниками. Я пойду к тебе на службу, но когда прийдет время и я все же решусь поселиться на берегу, не держи меня.";
