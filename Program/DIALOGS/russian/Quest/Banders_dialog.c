	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Step_5":
			switch (sti(pchar.questTemp.jailCanMove.Deliver.good))
			{
				...
				link.l1 = "Эк наглец. А твой приятель говорил, что друзья у него щедрые.";
		...
		case "Step_fight":
			dialog.text = "Если бы он не был таким болваном, то пил бы ром в таверне, а не помои в каземате. Так что все вопросы потом ему и задашь, ха-ха-ха! А теперь пиастры на бочку, иначе " + GetSexPhrase("живым","живой") + " отсюда не выйдешь.";
			link.l1 = "Ну, это мы сейчас поглядим...";
...
switch (rand(6))
	{
		...
		case 2:
			...
			pchar.questTemp.jailCanMove.Deliver.add = "сандала";
			break;
		case 3:
		...
		case 4:
			...
			pchar.questTemp.jailCanMove.Deliver.add = "шелка";
			break;
		case 5:
...
switch (rand(3))
	{
		case 0:
			...
			pchar.questTemp.jailCanMove.Deliver.add2 = "испанской Вест-Индской торговой Компании";
			break;
		case 1:
			pchar.questTemp.jailCanMove.Deliver.Nation = FRANCE;
			pchar.questTemp.jailCanMove.Deliver.add1 = "французских";
			pchar.questTemp.jailCanMove.Deliver.add2 = "французской Вест-Индской торговой Компании";
			break;
		case 2:
		...
		case 3:
			...
			pchar.questTemp.jailCanMove.Deliver.add2 = "английской Вест-Индской торговой Компании";
			break;
	}
}
