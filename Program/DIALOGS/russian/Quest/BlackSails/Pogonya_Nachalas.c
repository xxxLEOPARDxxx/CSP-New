	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BS_PN_12":	//Флинт
			...
			dialog.text = "Я на 'Морже' заблокирую порт. Вейн, бери своих людей и через джунгли выдвигайся в поселение.\n"+ 
							""+pchar.name+", на другой стороне острова, в заливе Руны, есть вход в подземелье, выдвигайся туда. Ровно через час ударим с трёх сторон и возьмём всё под контроль.";
		...
		case "BS_PN_12_loop":	//Флинт
			dialog.text = "Медлить нельзя. Иди к заливу Руны. Он на другом конце острова. Проплыви немного вдоль берега и увидишь вход в подземелье.";
			link.l1 = "Ладно, иду.";
			link.l1.go = "exit";
			NextDiag.TempNode = "BS_PN_12_loop";
		break;
		...
		case "BS_PN_21":	//Сильвер
			dialog.text = "Итак господа, 'Урка Де Лима', судя по расшифровке, уже в Гаване. Там она возьмёт на борт две роты морской пехоты и в сопровождении четырёх военных кораблей отправится к Пуэрто-Рико, где к эскадре присоединится ещё два корабля охранения. После чего, вся армада отправиться в Европу.";
			link.l1 = "...";
