...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Starshka_3":
			...
			link.l1 = "Миледи, я не смогу найти ваше кольцо без точного описания... Всего доброго.";
		...
		case "Starshka_5":
			dialog.text = "Вы не видели моё кольцо, "+ GetSexPhrase("месье","мадемуазель") +"?";
			link.l1 = "О, нет, миледи. Я пока ещё не "+ GetSexPhrase("нашёл","нашла") +" его.";
			link.l1.go = "exit";
			PlayVoice("Kopcapkz\Voices\PDM\Old Woman.wav");
		break;
		...
		case "Kupit":
			dialog.text = "Двадцать тысяч миллионов! И не меньше, за волшебное-то кольцо! Кольцо волшебное! Мне сказал"+ GetSexPhrase("","а") +" это дорог"+ GetSexPhrase("ой","ая") +" "+pchar.name+", я припоминаю!";
			link.l1 = "Вот - (дать ей двадцать).";
			link.l1.go = "Kupit_20";
			link.l2 = "Вот - (дать ей двадцать тысяч).";
			link.l2.go = "Kupit_20000";
		...
		case "Kupit_20":
			...
			link.l1 = "Спасибо. Я уверен, что теперь ты сможешь купить дворец губернатора. До свидания.";
			link.l1.go = "Pomenyt";
		...
		case "Popitka_Vtoraya_2":
			dialog.text = "Ты принес мне двадцать тысяч миллионов за волшебное кольцо?";
			link.l1 = "Вот - (дать ей двадцать).";
			link.l1.go = "Kupit_20";
			link.l2 = "Вот - (дать ей двадцать тысяч).";
			link.l2.go = "Kupit_20000";
		...
		case "UNasKoltso":
			dialog.text = "Эй, моряк! У меня есть двадцать тысяч миллионов! Знаешь, откуда они у меня??";
			link.l1 = "Конечно! Я их тебе дал.";
		...
		case "UNasKoltso_2":
			dialog.text = "Да, это был ты! Теперь я куплю дворец губернатора! И я приглашаю тебя в гости!";
		...
		case "Konets":
			dialog.text = "Вы не видели моё кольцо, месье? Я потеряла кольцо. Оно должно быть где-то здесь. Мне так неловко, я с трудом могу вспомнить... Иногда мне кажется, что я потеряла что-то ещё... Что-то, что я забыла...";
			link.l1 = "Да, я знаю, что вы потеряли. Я принёс вам ваше кольцо, миледи. Его сняли с тела вашего сына - который погиб во время сражения у стен Санто-Доминго. Вот, возьмите ваше кольцо.";
			link.l1.go = "Konets_2";
		...
		case "Konets_2":
			...
			{		
				...
				link.l1 = "Жизнь не кончается, миледи. Я думаю, вам надо найти ваших родственников - я уверен, что они очень по вам скучают. До свидания.";
				link.l1.go = "Nagrada_malo";
				link.l2 = "Миледи, возьмите 15000 монет, я уверен, что они помогут вам найти ваших родственников. Они по вам очень скучают. Жизнь еще не закончена, помните это. До свидания.";
