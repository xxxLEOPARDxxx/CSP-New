...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Konets":
			...
			link.l1 = "Да, я знаю, что вы потеряли. Я принёс вам ваше кольцо, мадам. Его сняли с тела вашего сына - который погиб во время сражения у стен Санто-Доминго. Вот, возьмите ваше кольцо.";
			link.l1.go = "Konets_2";
