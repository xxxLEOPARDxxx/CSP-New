...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "PortSpein_3":
			dialog.text = "Очень хорошо. Но я должен быть уверен, что эта вещь попадет именно тому, кто сумеет верно ею распорядиться - я обещал это одному человеку. Поэтому я предлагаю вам ответить на один вопрос, чтобы я мог понять, действительно ли вы т"+ GetSexPhrase("от","а") +", кто мне нуж"+ GetSexPhrase("ен","на") +". Согласны?";
		...
		break;
		case "PortSpein_ok":
			dialog.text = "Это старая карта сокровищ. Говорят, их спрятал сам сэр Уолтер Райли. Отдаю ее вам, согласно данному мной обету - передать из рук в руки опытному моряку. Удачи вам в поисках!";
		...
		break;
		case "PortPax_ok":
			dialog.text = "Это великолепный костюм, последний писк европейской моды! Спрятан он в подземелье под Тортугой, в одном из тупиков. Придется поискать.";
		...
		case "SanJuan_check":
			...
			{
				dialog.text = "Нет, "+ GetSexPhrase("капитан","девушка") +", ответ неверный. Предлагаю все-таки дать правильный ответ.";
				link.l1 = "Повторим...";
...
// теперь должно работать корректно   :  если у ГГ валиднось лицензии 50 дней, то взамен выдается лицезия сроком на 70 дней  			
// ежели лицезии не водится ( типа нелегал, или просрочена) то выдается стандартно на 40 дней
			...
			else // если с кем -то в раздрыганных  отношениях, то проверим наличие и валидность лицензии
			{
				...
				{
					GiveNationLicence(iNation, LicenceValidity); // даем лицезию на 40 дней по дефолту
				}
...
// -> ugeen fix			
			dialog.text = "Это " + GetRusNameNationLicence(iNation) + " сроком на " + LicenceValidity + " дней! С удовольствием вручаю ее вам.";
		...
		case "Cumana_check":
			...
			{
				dialog.text = "Очень жаль, "+ GetSexPhrase("капитан","девушка") +". Мне действительно очень жаль... Ответ неверный! Попробуете еще раз?";
				link.l1 = "Попробую!";
				link.l1.go = "Cumana_6";
				link.l2 = "Нет, пожалуй...";
				link.l2.go = "Cumana_7";
		...
		break;
		case "PortRoyal_2":
			dialog.text = "Ничего особенного. Я хочу знать, что эта вещь в надежных руках.";
		...
		case "PortRoyal_check":
			...
			{
				dialog.text = "Ответ неверный, "+ GetSexPhrase("капитан","девушка") +". Мне нужен правильный ответ. Еще попытаетесь?";
		...
		break;
		case "PortRoyal_ok":
			dialog.text = "Это гвардейская кираса. Найти ее ты сможешь на Ямайке в бухте Портленд.";
		...
		case "Santiago_check":
			...
			{
				dialog.text = "Хм, "+ GetSexPhrase("капитан","девушка") +", этот ответ меня устроить не может. Он неправильный! Прошу вас, попробуйте еще раз...";
