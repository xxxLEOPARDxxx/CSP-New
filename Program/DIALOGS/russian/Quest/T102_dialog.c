...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Term_1":
			...
			if(startherotype == 2)
			{
				link.l1 = "'Скайнет продакшн'? Никогда не слышала о такой корпорации. Проклятье, кажется своими действиями здесь я нарушила временную последовательность, чем породила альтернативное будущее. Скажи мне, известро ли тебе что-то о корпорации Omnitech? Кажется, в 2022 году она уже существовала.";
