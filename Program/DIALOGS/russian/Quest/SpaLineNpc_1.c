...
//********************************* Расследование убийства. Квест №4 **********************************
		...
		break;
 		case "Step_S4_6":
			dialog.text = "У-у-у, да вы весьма осведомлены об этом моем приключении, даже знаете, скольких испанских дьяволов я отправил на тот свет... Я впечатлен. Так кто же вы, судар"+ GetSexPhrase("ь","ыня") +"?";
...
//********************************* Уничтожение Ла Веги. Квест №5 **********************************
 		case "Step_S5_1":
			dialog.text = "Агрх, "+ GetSexPhrase("испанский пес","испанская дрянь") +"! Старый буканьер дорого продаст свою жизнь...";
