...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ring_4":
			...
			link.l1 = "Нет, приятель, не заинтересовало меня твое предложение. Драться в трюме полузатопленного корабля со стаей крабов ради сомнительных трофеев - это не по мне. Поищи "+ GetSexPhrase("другого рискового парня","кого-нибудь другого") +", "+ GetSexPhrase("который","кто") +" будет таскать для тебя каштаны из огня.";
