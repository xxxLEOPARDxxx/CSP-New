...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FS_1":
			dialog.text = "Бывает, "+ GetSexPhrase("месье","мадемуазель") +"... Я поначалу просто от страха умирал в такие дни, а сейчас привык.";
		...
		break;
		case "FT_2":
			dialog.text = "Очень много всего, "+ GetSexPhrase("месье","мадемуазель") +", очень много. И все сразу, представьте себе! Сперва рабы подняли восстание, а в самый разгар подавления нас атаковали охотники за головами, потому что у нас на борту находился один... человек, который был им нужен.\n"+
		...
		break;
		case "FT_5":
			dialog.text = "Нет, "+ GetSexPhrase("приятель","мадемуазель") +", я пас. С нашим адмиралом можно оказаться на дне гораздо раньше, чем снимешься с якоря.";
		...
		case "int_quests":
			...
			{
				link.l5 = "Слушай, а на чем эти корабли держатся в шторм?";
		...
		break;
		case "ansewer_3_1":
			dialog.text = "Только если случится чудо. Сам"+ GetSexPhrase("","а") +" посуди, вокруг скалы и рифы...";
		...
		break;
		case "Tizer_3":
			dialog.text = "Тизеру Дэну? Хо!.. Ты меня изрядно удивил"+ GetSexPhrase("","а") +", "+ GetSexPhrase("приятель","красавица") +". Тизер Дэн мертв.";
		...
		break;
		case "Tizer_5":
			dialog.text = "Ни за что на свете, "+ GetSexPhrase("дружище","" + pchar.name + "") +"!";
			link.l1 = "Хорошо, буду ждать тебя на 'Протекторе'.";
			link.l1.go = "exit";
			AddQuestRecord("ISS_MainLine", "8");
			AddQuestUserData("ISS_MainLine", "sSex", GetSexPhrase("нашел плотника и аккуратно переговорил с ним","нашла плотника и аккуратно переговорила с ним"));
