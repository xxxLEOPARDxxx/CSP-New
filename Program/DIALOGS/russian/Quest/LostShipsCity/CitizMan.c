	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "Приветствую "+ GetSexPhrase("нового гражданина","новую гражданку") +" Города! Очень рады тебя видеть. Простите, я забыл представиться. Меня зовут " + GetFullName(npchar) + ", я здесь живу.";
					link.l1 = "Это я заметил"+ GetSexPhrase("","а") +". Ну а я - " + GetFullName(pchar) + ".";
					link.l1.go = "FS_1";
				}
				else
				{				
		...
		//вопросы
		case "int_quests":
			dialog.text = "Внимательно тебя слушаю, "+ GetSexPhrase("дружище","дорогая") +".";
