...
//********************************* Диалоги тюремщика по четвертому квесту английки **********************************
 		case "Step_E4_1":
			dialog.text = "Нет, спрашиваю. Вляпал"+ GetSexPhrase("ся","ась") +" ты серьезно. А что случилось то? Что за шум был в городе из-за тебя?";
...
//**************************************** Диалоги Морриса Уильямса **************************************
        ...
        case "Step_E6_7":
            ...
            link.l2 = "У меня есть 140 000. Я виноват"+ GetSexPhrase("","а") +" перед тобой, ведь из-за меня ты попал в ловушку. Так что бери и решай свои проблемы.";
        ...
        case "Willams_GiveMoney":
            ...
            link.l1 = "Да, точно, упустил"+ GetSexPhrase("","а") +" из виду... Но ничего, я скоро вернусь, долго ждать тебе не придется.";
            link.l1.go = "exit";
        ...
        else
        {
            ...
            link.l1 = "Вот черт, забыл"+ GetSexPhrase("","а") +" в каюте. Сейчас сбегаю, и все 140000 будут у тебя, не волнуйся.";
            link.l1.go = "exit";
        ...
        case "Step_E6_14":
            dialog.text = "Вещица - это кираса, второй такой на Карибах, полагаю, нет. Об стальном слушай дальше... \n"+
                          ...
                          "Ну а ты смотри сам"+ GetSexPhrase("","а") +", можешь и попытаться. Возможно, мои пираты просто удрали с деньгами прямиком в Старый Свет или еще куда. Кто его знает...\n"+
			...
			//слухи
			AddSimpleRumour("Моррис Вильямс всюду только и говорит, как"+ GetSexPhrase("ой","ая") +" вы отчаянн"+ GetSexPhrase("ый","ая") +" рубака, прекрасный кэп и честн"+ GetSexPhrase("ый человек","ая девушка") +". Характеристика, однако, просто великолепная! Не думал даже, что еще живут такие люди на земле.", ENGLAND, 5, 1);
        break;
        ...
        case "Step_E6_11":
            ...
            link.l2 = "Знаешь, твое хамство мне уже порядком надоело. В конце-то концов, я тебе ничем не обязан"+ GetSexPhrase("","а") +". Прощай и будь здоров.";
