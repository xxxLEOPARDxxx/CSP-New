...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Tichingitu":
			...
			link.l1 = "Тебя зовут Тичингиту? Хм. Послушай, воин, я пришёл не для того, чтобы пялить на тебя глаза, а чтобы спросить: зачем ты полез в дом к этому мужику?";
		...
		case "Tichingitu_12":
			dialog.text = "Тичингиту не раб, бел"+GetSexPhrase("ый","ая")+" господин. Тичингиту - свободный индеец. Тичингиту хотеть служить у тебя. Индеец уметь сражаться, любой пёс умереть, прежде чем подойти к господин. Тичингиту уметь чистить и заряжать мушкет. Тичингиту уметь стрелять из мушкет.";
