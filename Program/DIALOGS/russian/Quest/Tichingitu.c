...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Tichingitu_10":
			...
			link.l1 = "Чего? Ты это о чём сейчас? Какой господин, какая жизнь? Ты разве не понял - ты свободен! Ступай!";
		...
		case "Tichingitu_11":
			...
			link.l1 = "Тьфу ты, дьявол... Да какой я тебе господин, Тичингиту? Я помог тебе не для того, чтобы превратить тебя в раба.";
			link.l1.go = "Tichingitu_12";
		break;
		
		case "Tichingitu_12":
			dialog.text = "Тичингиту не раб, белый господин. Тичингиту - свободный индеец. Тичингиту хотеть служить у тебя. Индеец уметь сражаться, любой пёс умереть, прежде чем подойти к господин. Тичингиту уметь чистить и заряжать мушкет. Тичингиту уметь стрелять из мушкет.";
