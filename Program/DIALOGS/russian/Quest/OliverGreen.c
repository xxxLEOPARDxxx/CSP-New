...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            if (pchar.questTemp.Ascold == "SeekThreeObject" && CheckAttribute(pchar, "questTemp.Ascold.Oliver"))
            {
    			link.l2 = "Оливер, может, ты передумаешь насчет цены тех индейских предметов, о которых я тебе говорил"+ GetSexPhrase("","а") +"?";
        ...
        case "Step_H3_3":
            dialog.text = "Не кипятись, "+ GetSexPhrase("минхер","госпожа") +", все нормально. Голландцев среди пиратов много, а вот в Порт Рояле тебе сейчас находиться небезопасно.\n"+
                          "Поэтому вот что я тебе скажу: Морган на Антигуа, в своем доме. Там тоже будь аккуратнее - если я в тебе признал голланд"+ GetSexPhrase("ца","ку") +", то это не будет тайной и для других.\n"+
        ...
        break;
        case "Step_F8_3":
            dialog.text = "Ладно, ладно, "+ GetSexPhrase("месье","мадемуазель") +"... Морган сейчас находится в своем доме на Антигуа.";
		...
		//********************* Квест Асокльда *********************
   		case "Step_As_1":
			...
			link.l1 = "Ты не кипятись. Все дело в том, что я ищу три предмета индейского культа. Для покупки. Все одно - вы либо выбрасываете эту дрянь, либо продаете за бесценок. Я готов"+ GetSexPhrase("","а") +" заплатить щедро за эти вещи, если они у вас есть.";
