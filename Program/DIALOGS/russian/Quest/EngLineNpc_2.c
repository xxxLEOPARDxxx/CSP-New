...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            {
    			dialog.text = "Вы что-нибудь узнали о моем муже, "+ GetSexPhrase("сэр","мисс") +"?";
            ...
            {
                dialog.text = NPCStringReactionRepeat(""+ GetSexPhrase("Сэр","Мисс") +", я никогда не забуду, что вы для нас сделали. Вы спасли жизнь моему мужу и избавили нашу семью от долгов. Мы назовем нашего ребенка в вашу честь.",
...
//*********************************** Диалоги Джиллиан Эттербери *************************************
        ...
        case "Step_E6_28":
			dialog.text = "Он сказал только, что идет за город. Больше ничего, он очень спешил (плачет). "+ GetSexPhrase("Сэр","Мисс") +", я умоляю вас, помогите мне найти моего мужа!";
...
//**************************** Диалоги бандита в пещере, поиски мужа Джиллиан ****************************
 		case "Step_E6_30":
			dialog.text = "Кончайте "+ GetSexPhrase("его","ее") +", нам свидетели ни к чему...";
			link.l1 = "Хм...";
...
//************************************** Диалоги спасшегося буканьера ***********************************
		...
		break;
   		...
   		case "Step_E8_3":
			...
			link.l1 = "Черт возьми! Я приехал"+ GetSexPhrase("","а") +" к Мэнсфилду по поручению Мэдифорда. Я долж"+ GetSexPhrase("ен","на") +" забрать приготовленное для него золото.";
