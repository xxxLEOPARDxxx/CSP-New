void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "zpq_sld2_1":
			dialog.text = "Вы-то нам и нужны. А вернее, ваше золото. И не вздумайте упрямиться, я сегодня не в настроении - могу и разозлиться ненароком.";
			link.l1 = "Да помилуйте, какое золото? Не думаете же вы, что я стану носить с собой казну.";
		...
		case "zpq_sld2_2":
			...
			{
				link.l1 = "Уж не на эту ли тюремную крысу вы работаете? Тогда могу вас обрадовать - я отправил"+ GetSexPhrase("","а") +" его к праотцам. Так что проваливайте, пока вас не отправил"+ GetSexPhrase("","а") +" следом.";
				link.l1.go = "zpq_sld2_3_1";
			}
			else
			{
				link.l1 = "Уж не на эту ли тюремную крысу вы работаете? Передайте ему, что золото попало в надёжные руки, пусть забудет о нём!";
