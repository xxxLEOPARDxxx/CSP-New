...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            {
    			dialog.text = ""+ GetSexPhrase("Чертов ладрон","Чертова девка") +"!";
...
//********************************* Проблемы донны Анны. Квест №5 **********************************
		...
		break;
 		case "Step_F5_3":
			...
			link.l1 = "Надо успеть перехватить их в джунглях! Если они успеют вернуться в город, мне придется воевать со всем испанским гарнизоном. Спасибо вам, уважаемая Инес. Я никогда не верил"+ GetSexPhrase("","а") +" в женскую дружбу, но вы, отважная женщина, убедили меня в обратном. Прощайте.";
    		link.l1.go = "exit";
