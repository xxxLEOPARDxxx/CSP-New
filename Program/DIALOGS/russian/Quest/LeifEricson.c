...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            {
            	dialog.text = "Ты справил"+ GetSexPhrase("ся","ась") +" с моими слугами, это хорошо. А теперь скажи мне, какой сейчас год?";
        		link.l1 = environment.date.year + "-й... Черт возьми, что происходит?!!";
        		link.l1.go = "Step_8";
            }
            if (pchar.questTemp.Ascold == "Ascold_BodyChange")
            {
            	dialog.text = "Ну вот, теперь все в порядке. Ты готов"+ GetSexPhrase("","а") +" выполнить свое предназначение?";
            ...
            {
            	dialog.text = "Теперь ты готов"+ GetSexPhrase("","а") +". Я разрешаю тебе покинуть гробницу.";
            ...
            if (pchar.questTemp.Ascold == "Ascold_MummyFoundItems")
            {
                ...
                {
                	link.l1 = "Их нет у меня, я их не наш"+ GetSexPhrase("ел","ла") +"...";
            		link.l1.go = "Step_30";
                }
            }
        ...
        case "Step_8":
    		...
    		link.l1 = "(про себя) Чтоб меня разорвало! (вслух) И похоже, это я тебя разбудил"+ GetSexPhrase("","а") +"...";
    		link.l1.go = "Step_9";
		break;
        ...
        case "Step_11":
    		...
    		link.l1 = "Ну, как тебе объяснить... Я свободн"+ GetSexPhrase("ый моряк и свободный воин","ая морячка и вольная птица") +". У меня свой корабль и я делаю то, что считаю нужным.";
    		link.l1.go = "Step_12";
		break;

        case "Step_12":
        	dialog.text = "Ха-ха! Да мы с тобой "+ GetSexPhrase("братья по крови","одной крови") +"! Я счастлив, что мой замысел осуществила родственная душа. Это знак большой удачи для меня...";
        ...
        case "Step_14":
    		...
    		link.l1 = "Когда я направлял"+ GetSexPhrase("ся","ась") +" сюда, я слышал"+ GetSexPhrase("","а") +", что здесь похоронен Лейф Счастливый. Это и есть ты?";
    		link.l1.go = "Step_15";
		break;
        ...
        case "Step_16":
        	dialog.text = "Викинг - это не нация, корсар. Викинг - это образ жизни, профессия моряка и воина.\n"+
                          "И ты, "+ GetSexPhrase("свободный воин","свободная морячка") +", называешь нас варварами? Шестьсот лет назад мы были лучшими воинами и моряками на земле. Я был в Йорсалире и участвовал в походе на Рим, а мой брат владел Гардарикой!";
    		link.l1 = "Но как ты оказался в Америке? Америку же открыл Христофор Колумб 150 лет назад!";
    		link.l1.go = "Step_17";
		break;

        case "Step_17":
        	dialog.text = "Америкой ты называешь эти большие земли? Ха-ха-ха. Слушай меня, "+ GetSexPhrase("свободный корсар","женщина-воин") +".\n"+
        ...
        case "Step_19":
    		...
    		link.l1 = "Здорово! Ну, я пош"+ GetSexPhrase("ел","ла") +"?";
    		link.l1.go = "Step_20";
		break;
        ...
        case "Step_22":
    		...
    		link.l1 = "Хм, и что я долж"+ GetSexPhrase("ен","на") +" сделать?";
    		link.l1.go = "Step_23";
        ...
        case "Step_23":
        	dialog.text = "Я чувствую, что здесь рядом стоит большой город. Там, у самого главного человека в городе, находятся нужные мне вещи, я ощущаю их присутствие.\n"+
                          "Ты долж"+ GetSexPhrase("ен","на") +" доставить мне три хрустальных черепа тольтеков - белый, розовый и голубой, а также древний предмет, именуемый странной вещью. Тогда я стану сильней и смогу восстановить свое тело. Мир ждет своего властителя...";
        ...
        case "Step_24":
        	dialog.text = "В общем, да. Только еще одно ма-а-аленькое дельце, для того, чтобы ты побыстрей возвращал"+ GetSexPhrase("ся","ась") +".\n"+
        ...
        case "Step_31":
    		...
    		link.l1 = "Понял"+ GetSexPhrase("","а") +". Ну, будь здоров, если можно так сказать...";
    		link.l1.go = "exit";
    		chrDisableReloadToLocation = false; // открыть выход из локации.
