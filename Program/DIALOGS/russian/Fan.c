...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "FirstMeet":
			...
			link.l1 = "Так и быть...";
			link.l1.go = "exit";
			PlayVoice("Kopcapkz\Voices\Fan\Fan_FirstMeet.wav");
		break;
		...
		case "Scared":
			...
			link.l1.go = "Scared_2";
			PlayVoice("Kopcapkz\Voices\Fan\Fan_Scared.wav");
		break;
		...
		case "CoolStory":
			...
			switch (rand(20))
			{
				case 0:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_0.wav");
				break;
				case 1:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_1.wav");
				break;
				case 2:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_2.wav");
				break;
				case 3:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_3.wav");
				break;
				case 4:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_4.wav");
				break;
				case 5:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_5.wav");
				break;
				case 6:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_6.wav");
				break;
				case 7:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_7.wav");
				break;
				case 8:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_8.wav");
				break;
				case 9:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_9.wav");
				break;
				case 10:
					coolstory = "Все это дичь все эти перекрасы, которым уже десятки лет. Без новых моделей ничего не будет.";
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_10.wav");
				break;
				case 11:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_11.wav");
				break;
				case 12:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_12.wav");
				break;
				case 13:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_13.wav");
				break;
				case 14:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_14.wav");
				break;
				case 15:
				...
				case 17:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_17.wav");
				break;
				case 18:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_18.wav");
				break;
				case 19:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_19.wav");
				break;
				case 20:
					...
					PlayVoice("Kopcapkz\Voices\Fan\Fan_CoolStory_20.wav");
				break;
			}
