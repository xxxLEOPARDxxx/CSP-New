...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				dialog.text = RandPhraseSimple("Сеньор"+ GetSexPhrase("","ита") +", весь город благодарен вам по гроб жизни. Если бы не вы, даже страшно себе представить, что могло произойти...", "Весь город наблюдал за сражением - это была великая битва. Мы вам очень благодарны за спасение от грязных пиратов.");
        ...
        break;
		case "Step_F6_4":
            dialog.text = "Сеньор"+ GetSexPhrase("","ита") +", совершенно ясно, что мы в вашей власти. Я, как губернатор этого города, совершенно четко осознаю, в какой ситуации мы находимся. Забирайте все, что найдете, но денег, за которыми вы сюда пришли, здесь уже нет. Вы опоздали...";
			link.l1 = "Каррамба!! Я долж"+ GetSexPhrase("ен","на") +" обсудить судьбу города со своими компаньонами!";
            link.l1.go = "Step_F6_exit";
