    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if (pchar.questTemp.State == "Fr9GuardPP_GoodWork")
			{
				...
				link.l1 = "Барон"+ GetSexPhrase("","есса") +", сударь. Я - барон"+ GetSexPhrase("","есса") +", не просто капитан!.. Ну, а по этому поводу - да, спас"+ GetSexPhrase("","ла") +", и весьма рад"+ GetSexPhrase("","а") +" этому обстоятельству...";
				link.l1.go = "exit";			
			}
		break;
