...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "FraLine11Quest_OccupySC":
            dialog.text = "Это нападение - второе за последнее время! Французы сильно рискуют обратить на себя гнев Эскориала в полной мере.";
		...
		case "Step_F11_1":
			...
			link.l1 = "Дальше я намерен"+ GetSexPhrase("","а") +" сместить вас, привести жителей к присяге Людовику XIV и передать управление городом в руки французской администрации. Вы не будете против?";
