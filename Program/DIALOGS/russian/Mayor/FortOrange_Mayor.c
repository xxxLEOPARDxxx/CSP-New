    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			switch(pchar.questTemp.State)
            {
                case "TakeFoodCuracao_toOrangeMayor": //Голландская линейка, квест №2, доставка продовольствия из форта Оранж.
                    link.l2 = "Я прибыл"+ GetSexPhrase("","а") +" сюда по распоряжению Питера Стэвезанта. У вас для Кюрасао приготовлена партия товара, я долж"+ GetSexPhrase("ен","на") +" купить и доставить ее. Прошу вас ознакомиться с документами на предоставление специальных цен.";
        ...
        case "Step_H2_1":
			dialog.text = "Так, давайте прочтем... Ну что же, с бумагами все в порядке. Всю партию товара вы можете получить в местном магазине, я немедленно распоряжусь выдать ее вам.\n"+
                          "Партия состоит из кофе, черного, красного и сандалового дерева. Общий вес партии товара, приготовленного к отправке - 5600 центнеров. Рассчитайтесь в магазине - и можете приступать к погрузке.";
