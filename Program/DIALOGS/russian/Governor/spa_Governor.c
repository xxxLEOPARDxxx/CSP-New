...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                ...
                case "TakeRockBras_DieHardRock":
                    dialog.text = "Так, ну что вы мне скажете по поводу Рока Бразильца?";
                    link.l1 = "Я намерева"+ GetSexPhrase("лся","лась") +" атаковать его корвет в прибрежных водах Маракайбо, где он охотился на наши галеоны. К сожалению, по причинам, от меня не зависящим, мне пришлось покинуть воды, где находился Рок Бразилец. Он ушел от меня...";
                    link.l1.go = "Step_3_6";
                break;
                ...
                case "TakeRockBras_RockGiven":
                    ...
                    link.l1 = "Спасибо, дон Франсиско. Чем я еще могу быть вам полез"+ GetSexPhrase("ен","на") +"?";
                    link.l1.go = "Step_3_8";
                break;
                ...
                case "Sp8SaveCumana_YouLate":
                    ...
                    link.l1 = "Я мчал"+ GetSexPhrase("ся","ась") +" к Кумане на всех парусах, нигде не задерживаясь даже на минуту. Но все равно не успел"+ GetSexPhrase("","а") +" вовремя, сделать это было просто невозможно.";
                    link.l1.go = "Step_8_5";
        ...
        break;
        case "Step_1_3":
            dialog.text = "Похоже, что так оно и есть. Еще вчера "+ GetSexPhrase("такой субъект","такая особа") +", как вы, мог"+ GetSexPhrase("","ла") +" рассчитывать только на костер Святой Инквизиции или пеньковую веревку. Но времена изменились. Докажите свою преданность Господу нашему и Кастилии, и будете иметь все - богатство, славу, почести и награды.";
        ...
        case "Step_4_10":
            ...
            link.l1 = "Я настиг"+ GetSexPhrase("","ла") +" этого флибустьера, но убить его мне не удалось - он очень силен, мне пришлось ретироваться.";
        ...
        case "Step_4_16":
            ...
            link.l1 = "Оно уже свершилось - убийца дона Хосе мертв. Я разыскал"+ GetSexPhrase("","а") +" его на Тортуге и убил"+ GetSexPhrase("","а") +".";
        ...
        case "Step_7_5":
			...
			AddCharacterExpToSkill(pchar, "FencingHeavy", 120);
			//слухи
			AddSimpleRumour("Говорят, что вы спасли нашего героя Пардаля! Позвольте выразить вам свое восхищение, вы настоящ"+ GetSexPhrase("ий воин","ая воительница") +"!", SPAIN, 5, 1);
        break;
        case "Step_7_6":
...
//********************** Квест №8, Отбить нападение на Куману. ************************
        ...
        break;
        case "Step_8_2":
            dialog.text = "Эх, "+ GetSexPhrase("друг мой","дорогая сеньорита") +", нам довелось жить с вами в очень тяжелое время... Испания, наша родина, терпит удары со всех сторон. В Старом Свете мы теряем северные провинции в деволюционной войне с Людовиком, здесь усиливается давление на нас со стороны конкурирующих держав...\n"+
		...
		case "Step_8_7":
			...
			AddCharacterExpToSkill(pchar, "Fencing", 250);
 			//слухи
			AddSimpleRumour("Капитан, говорят, что это вы спасли Куману! Позвольте вам выразить свое восхищение, сеньор"+ GetSexPhrase("","ита") +"...", SPAIN, 5, 1);
        break;
//********************** Квест №9, Четыре золотых галеона. ************************
        ...
        break;
		case "Step_9_6":
            dialog.text = "Это очень плохо. Я понимаю, что вы оказались в тяжелейшей ситуации, но вы могли бы быть более расторопн"+ GetSexPhrase("ым","ой") +". А сейчас мне нужно отчитываться в Мадриде за серьезную недостачу в поставках золота... И это тогда, когда Испания ведет изнурительную борьбу в Европе!\n"+
				          "М-да, очень и очень плохо. Я рассчитывал на вас, а вы не сумели оправдать моего доверия.";
            link.l1 = "Дон Франсиско, поверьте мне, я сделал"+ GetSexPhrase("","а") +" все, что мог"+ GetSexPhrase("","ла") +". И даже более того... Однако силы были слишком неравны, а у меня был всего один корабль для защиты четырех галеонов! Кстати, по настоянию губернатора Порто Белло. Может быть, спросить по всей строгости закона с него?";
            link.l1.go = "Step_9_7";
        break;
		case "Step_9_7":
        ...
        break;
		case "Step_9_8":
            dialog.text = "Черт возьми!!! Как же такое могло случиться?! Я понимаю, что вы оказались в тяжелейшей ситуации, но вы могли бы быть более расторопн"+ GetSexPhrase("ым","ой") +". А сейчас мне нужно отчитываться в Мадриде за серьезную недостачу в поставках золота... И это тогда, когда Испания ведет изнурительную борьбу в Европе!";
		...
		case "Step_9_10":
            dialog.text = "Я даже слушать ваших оправданий не желаю. Идите вон!\n"+
				          "Впрочем, вы можете заходить ко мне, возможно, будет кое-какая работенка для "+ GetSexPhrase("такого бездаря","такой неумехи") +"...";
            link.l1 = "Хорошо, дон Франсиско.";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
		...
		case "Step_9_16":
            ...
            link.l1 = "Сеньор генерал-губернатор, вы же знаете, в какую переделку я попал"+ GetSexPhrase("","а") +" и что нам довелось пережить. Паника на галеонах, творилось черт знает что...";
...
//********************** Квест №10, Защита Маракайбо ************************
		case "Step_10_1":
            ...
            link.l1 = "Сеньор, насколько вам известно, выполняя поручение губернатора Порто Белло, я попал"+ GetSexPhrase("","а") +" в серьезную переделку...";
        ...
        break;
		case "Step_10_8":
            dialog.text = "Я более не желаю иметь с вами никакого дела. Таких трусов и разгильдяев не было еще на службе Испании! Какой позор... Все, разговор с вами окончен раз и навсегда, прощайте.";
            link.l1 = "...";
            link.l1.go = "exit";
