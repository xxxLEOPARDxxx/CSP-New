    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
			...
			switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                case "empty":   // Нет взятых квестов
                    ...
                    else
                    {
						switch(pchar.questTemp.CurQuestNumber)   // Взятие квестов начиная со второго
                        {
                            ...
                            break;
                            case "8":
                                dialog.text = "Вы опять нужны мне, "+ GetSexPhrase("друг мой","" + pchar.name + "") +". Мне необходимо направить надежного человека к главе поселения буканьеров Ла Вега, что на Эспаньоле. Да вы же знаете Эдварда Мэнсфилда, по моему поручению вы уже были у него. Помните?";
                ...
                case "MorrisWillams_PinnaceBoard":
                    dialog.text = "Слышал, вы взяли на абордаж испанский пинас прямо возле Сан-Хуана под огнем форта?!! Надо сказать, рискованная операция...";
                ...
                case "ToMansfield_GaleonSink":
                    ...
                    {
                        dialog.text = "Вы смогли настигнуть испанцев?";
                        link.l1 = "Рядом с Сантьяго я "+ GetSexPhrase("сумел","сумела") +" взять на абордаж испанский галеон, один из тех, что учавствовали в нападении на буканьеров. Мне удалось настигнуть один из трех нападавших галеонов и потопить его. Куда ушли два других галеона, мне неизвестно.";
                    }
                    link.l1.go = "Step_8_5";
                ...
                case "OccupyMein_GoOn":
                    ...
                    {
                        dialog.text = "Вы захватили Каракас! Это прекрасно, "+ GetSexPhrase("друг мой","" + pchar.name + "") +". Но Кумана еще не захвачена. Поторопитесь!";
                        link.l1 = "Хорошо, сэр.";
                        link.l1.go = "exit";
                    }
        ...
        case "Step_9_1":
            ...
            else // признак результата завершения квеста, 1 == было захвачено письмо
            {
                ...
                link.l1 = "Да, сэр. Письмо я "+ GetSexPhrase("прочел","прочла") +".";
                link.l1.go = "Step_9_2";
            }
