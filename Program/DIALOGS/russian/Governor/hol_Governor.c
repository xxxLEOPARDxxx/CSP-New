...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                ...
                case "":           // Квест №1, доставка главы янсенистов мистера Аарона.
                    dialog.text = "Ну что же, у меня есть для вас весьма важное для города задание. Полагаю, оно будет вам по зубам.\n"+
                                  "Дело вот в чем: к нам на Кюрасао в последнее время стало прибывать довольно много протестантов из Европы, в основном из Фландрии и Бургундии, где свирепствует инквизиция. Недавно к нам прибыли так же сторонники учения Янсения. Дабы возглавить общину янсенистов, французским рейсовым кораблем из Голландии на Сан-Мартин прибыл влиятельный янсенист Аарон Мендес Чумакейро.\n"+
                ...
                case "TakeFoodCuracao_toOrangeStore":
                    ...
                    if (GetQuestPastDayParam("questTemp") > 60)
                    {
                        ...
                        link.l1 = "Верно, я не уложил"+ GetSexPhrase("ся","ась") +" по времени - были серьезные проблемы с ветром...";
                    }
                    link.l1.go = "Step_2_5";
                break;
        ...
        case "Step_2_5":
            ...
            link.l1 = tempStr;
            link.l1.go = "Step_2_6";
            if (tempStr == "Минхер, я привез"+ GetSexPhrase("","ла") +" следующие товары.")
            {
        ...
        break;
        case "Step_5_7":
            dialog.text = "Черт возьми, какая ужасная новость! Что же, спасибо за информацию, "+ GetSexPhrase("друг мой","госпожа") +". Мэнсфилда жаль...";
        ...
        case "Step_7_13":
			...
			//слухи
			AddSimpleRumour("Говорят, что капитан " + GetFullName(pchar) + ", выполняя функции вестового Стэвезанта, попал"+ GetSexPhrase("","а") +" в серьезнейшую переделку - на не"+ GetSexPhrase("го","е") +" неожиданно напали испанцы прямо в Тортуге. Но "+ GetSexPhrase("он вышел","она вышла") +" из схватки победителем.", HOLLAND, 5, 1);
        break;
        ...
        case "Step_9_10":
            ...
            link.l1 = "Я просто высказал"+ GetSexPhrase("","а") +" свое мнение...";
