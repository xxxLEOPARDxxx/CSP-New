	...
	switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                case "empty":   // Нет взятых квестов
                    ...
                    else
                    {
						switch(pchar.questTemp.CurQuestNumber)   // Взятие квестов начиная со второго
                        {
                            ...
                            break;
                            case "5":
                                dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", для вас снова поручение деликатного свойства. У меня есть серьезные опасения за жизнь донны де Лейва. Навестите ее, пожалуйста, она сейчас у меня в резиденции в соседней комнате. Сеньора посвятит вас в подробности.";
                            ...
                            break;
                            case "11":
                                dialog.text = "Итак, барон"+ GetSexPhrase("","есса") +", Франция ждет от вас новых свершений. На этот раз военная операция, весьма сходная с предыдущей.";
                ...
                case "Fr1Legran_LegranKilled":
                    ...
                    link.l1 = "Я выполнил"+ GetSexPhrase("","а") +" ваше задание, все в порядке. Более того, я помог"+ GetSexPhrase("","ла") +" Леграну разделаться с бандитами, которые пытались его ограбить.";
                    link.l1.go = "Step_1_3";
                break;
                ...
                case "Fr4SoleiRoyal_backTortuga":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", доложите о выполнении задания.";
                    link.l1 = "Все в порядке, месье, хоть и не без проблем. Я отразил"+ GetSexPhrase("","а") +" нападение испанской эскадры под командованием того самого Хуана Галено, французской эскадры близ Доминики я не наш"+ GetSexPhrase("ел","ла") +", поэтому пришлось доставить 'Солей Руаяль' в Бас-Тер.";
        ...
        case "Step_1_1":
            dialog.text = "Вы верно уловили. Месье Леграну нужно тайно попасть на Мартинику, потом он сумеет отправиться оттуда рейсовым кораблем в Дьепп. Но он «сидит» на куче золота и это знают все, поэтому есть серьезные опасения за благополучный исход возвращения в Старый Свет.\n"+
				          "Отправляйтесь в таверну - там вы найдете Леграна. Ваша задача — доставить его в бухту Ле Марен, что на Мартинике. Пьер отблагодарит вас, судар"+ GetSexPhrase("ь","ыня") +".";
        ...
        case "Step_1_4":
			...
			AddCharacterExpToSkill(pchar, "Sneak", -170);
			//слухи			
			AddSimpleRumour("Вы слышали, капитана " + GetMainCharacterNameGen() + " наш генерал-губернатор выставил из резиденции за какую-то темную историю, связанную с Леграном... Теперь у не"+ GetSexPhrase("го","е") +" 'волчий билет.'", FRANCE, 5, 1);
        break;
        case "Step_1_5":
        ...
        break;
		case "Step_1_6":
            dialog.text = "И это действительно так, "+ GetSexPhrase("месье","мадемуазель") +" " + pchar.lastname + ". Ну что же, печально, что так вышло, но, тем не менее, я благодарен вам за содействие. Поэтому прошу вас заглядывать ко мне время от времени - возможно, подвернется работа для флибустьера.";
		...
		case "Step_1_11":
            dialog.text = "Ну что же, мы в расчете. Вы можете теперь бывать у меня, я буду давать вам работу время от времени, судар"+ GetSexPhrase("ь","ыня") +"."; 
        ...
        case "Step_2_8":
			...
			//слухи
			AddSimpleRumour("Вы слышали, капитан " + GetFullName(pchar) + " исполнял"+ GetSexPhrase("","а") +" обязанности вестово"+ GetSexPhrase("го","й") +" нашего генерал-губернатора. И знаете, странная история приключилась с н"+ GetSexPhrase("им","ей") +" в Виллемстаде - е"+ GetSexPhrase("го","ее") +" арестовали. Но к чести французов, "+ GetSexPhrase("он сумел","она сумела") +" выпутаться из ситуации. Д'Ожерон, должно быть, доволен...", FRANCE, 5, 1);
		break;
        //********************** Квест №3 похищение донны Анны ************************
        case "Step_3_1":
            dialog.text = "О вас ходит молва, что вы отчаянн"+ GetSexPhrase("ый головорез","ая сорвиголова") +", и я знаю, что для вас слово 'честь' не пустой звук. Сознаюсь, мне нелегко довериться вам, но полагаю, это лучший вариант... Моя жизнь в ваших руках, и вам решать, разменяете ли вы ее на золото или докажете, что вы "+ GetSexPhrase("рыцарь","благородная женщина") +"!";
			link.l1 = "Черт возьми, любой скажет, что я умею резать глотки, но никто не посмеет сказать, что я "+ GetSexPhrase("подлец и предатель","предательница") +"! Я слушаю вас.";
            link.l1.go = "Step_3_2";
        break;
        case "Step_3_2":
		...
		case "Step_4_check":
			...
			//слухи
			AddSimpleRumour("Ходят слухи, что при сопровождении 'Солей Руаяля' на вас напали испанцы! Позвольте выразить вам свое восхищение"+ GetSexPhrase(" - вы прекрасный моряк и настоящий воин"," - вы настоящая Жанна д'Арк") +"!", FRANCE, 5, 1);
			DialogExit();
        break;
		...
		case "Step_7_6":
            dialog.text = "Хм, бесполезно в вашем исполнении, "+ GetSexPhrase("месье","мадемуазель") +". Не говорите за весь Новый Свет.\n"+
				          "Очень жаль, судар"+ GetSexPhrase("ь","ыня") +", что вы не сумели выполнить задания, очень жаль... Пожалуй, вы мне больше не нужны. Вы можете заглядывать ко мне в резиденцию периодически, возможно, и для вас найдется работа...";
			link.l1 = "Хорошо, месье генерал-губернатор.";
        ...
        break;
		case "Step_9_2":
            dialog.text = "Верно, барон"+ GetSexPhrase("","есса") +", и выполнена блестяще. Французское правительство предусмотрело определенную сумму на ремонт кораблей и пополнение личного состава - 5 тысяч золотых... Извольте получить.";
        ...
        break;
		case "Step_9_6":
            dialog.text = "Черт возьми, да вы просто "+ GetSexPhrase("форменный трус","трусливая девчонка") +"! Я не желаю иметь с вами ничего общего. Прощайте, барон"+ GetSexPhrase("","есса") +"...";
