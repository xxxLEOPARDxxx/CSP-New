...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "GoodTalk_2_4":
			...
			link.l1 = "Понятно. Ну что же, извини, что "+ GetSexPhrase("отвлек","отвлекла") +" от дел.";
		...
		case "GoodTalk_3_2":
			...
			link.l1 = "Да, это я и есть. Но я говорю правду без всяких 'якобы'. И я бы "+ GetSexPhrase("порекомендовал","порекомендовала") +" вам воспринимать все это серьезно - большие деньги предлагаются за эту работу.";
