...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
		...
		case "Tichingitu":
			dialog.text = "А-а, Аскольд и вам рассказал свою историю? Не вижу причин препятствовать вам. Вы не первый, кто приходит смотреть на этого краснокожего. Хотя дней через десять на него смогут полюбоваться все жители нашего города, когда мы его вздёрнем сушиться на солнышке...";
		...
		case "Tichingitu_4":
			dialog.text = "Ох, молодой человек, не вдавайтесь в философию! Если вас так задел этот вопрос - отправляйтесь к Аскольду и просите за индейца именно его. Если он напишет ходатайство о помиловании - мы удовлетворим его.";
			link.l1 = "Я всё понял, офицер. Отправляюсь.";
