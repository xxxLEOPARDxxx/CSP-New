void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Node_132_10":
			...
			dialog.text = "Клад спрятан в пещере на " + XI_ConvertString(pchar.GenQuest.EncGirl.islandId + "Acc") + ", нам нужно высадится у " + XI_ConvertString(pchar.GenQuest.EncGirl.shoreId + "Gen") + ", а место покажу сама... Только, чур, делить пополам будем!";
