...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l1 = "Я уполномочен"+ GetSexPhrase("","а") +" засвидетельствовать вам свое почтение и ознакомить с моими документами. Извольте прочесть мою торговую доверенность Французской Ост-Индской компании.";
...
//************************************* Французская линейка, квест №4, Солей Руаяль *******************************
 		case "Step_F4_1":
            ...
            {
                dialog.text = "Да, я уже уведомлен, "+ GetSexPhrase("месье","мадемуазель") +". Принимайте командование. По чести сказать, командовать таким кораблем - счастье даже для адмирала...";
