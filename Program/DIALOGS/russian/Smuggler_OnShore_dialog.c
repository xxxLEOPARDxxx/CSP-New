...
//================ METRO ====================
		...
		case "Make_trade_Edit":
			...
			dialog.Text = "Какое количество? У тебя есть груз '" + XI_ConvertString(Goods[sti(Pchar.quest.Contraband.ChooseGoodsID)].name) +"' " + i + " шт.";
   			Link.l1.edit = 1;
			Link.l1 = i;
		...
		case "Make_trade_Edit2":
			...
			{
			    dialog.Text = "Такое количество не могу принять.";
       			Link.l1 = "Повторить.";
