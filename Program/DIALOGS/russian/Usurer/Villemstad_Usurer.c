            ...
            if (pchar.questTemp.State == "Inquisition_toCuracao" || pchar.questTemp.State == "Inquisition_afterFrancisco" )// квест №2 голл. линейки.
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            dialog.text = "Что, ты еще не все мне сказки "+ GetSexPhrase("рассказал","рассказала") +" про прощение Папы?";
                			link.l1 = "Ладно, Йозеф, поговорим еще...";
                			link.l1.go = "exit";
                        }
                        else
                        {
                            dialog.text = "Что еще тебе нужно, "+ GetSexPhrase("проклятый кровопийца, иезуитский прихвостень","проклятая кровопийца, иезуитская прихвостня") +" ...";
...
//********************** Пиратская линейка, квест №5 ОГЗ ************************
		...
		break;	
		case "Step_P5_2":
			dialog.text = "Понятия не имею. Он вольный человек, ходит, где заблагорассудится. А насчет того, что он еще в Виллемстаде, это вряд ли, здесь для него работы не осталось. Вы же "+ GetSexPhrase("приятель","приятельница") +" Джона, должны понимать, что искать его надо там, где ром льется рекой - в тавернах!";
