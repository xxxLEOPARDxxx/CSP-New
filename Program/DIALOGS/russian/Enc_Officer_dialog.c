...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "contract2": 
			...
			Link.l1 = "Большая единоразовая оплата. Экипировка получше, сам понимаешь. Срок контракта 10 лет. Уволится можешь по истечению срока, а если все будет устраивать нас обоих, продливаем дальше."; 
