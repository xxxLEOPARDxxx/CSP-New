		...
		case "quests":
            ...
            switch(pchar.questTemp.State)
            {
                ...
                case "DelivLettTortuga_toStranger": //Голландская линейка, квест №7. узнаем о ожидающем ГГ человеке.
                    link.l1 = "Слушай, ты не в курсе дела? Меня тут ждут, я "+ GetSexPhrase("прибыл","прибыла") +" из Кюрасао...";
...
//============================ Голл. линейка, квест №7. узнаем о ожидающем ГГ челе =======================
 	 	case "Step_H7_1":
			dialog.text = NPCStringReactionRepeat("В курсе. Пройди в комнату наверху, там тебя ждет какой-то тип.", "Ты уже "+ GetSexPhrase("задавал","задавала") +" мне этот вопрос сегодня.", "Опять?", "Может ты не будешь меня отвлекать от работы?", "block", 1, npchar, Dialog.CurrentNode);
			link.l1 = HeroStringReactionRepeat("Спасибо, старина.", "Верно, "+ GetSexPhrase("задавал","задавала") +"...", "Хм, извини...", "Хорошо, не буду. Извини...", npchar, Dialog.CurrentNode);
...
//============================ Голл. линейка, квест №8. узнаем о Лоране де Графе =======================
        ...
        break;
  	 	case "Step_H8_3":
			...
			link.l1 = "Он мне нужен срочно по очень важному делу. "+ GetSexPhrase("Искал","Искала") +" его на Бермудах, теперь ищу здесь. Я "+ GetSexPhrase("сам голландец","сама голландка") +", как и Лоран...";
...
//============================ Испанская линейка, квест №4. узнаем о донне Анне. =======================
        ...
        break;
  	 	case "Step_S4_5":
			...
			link.l1 = "Вижу, что Тортуга процветает и я этому весьма и весьма "+ GetSexPhrase("рад","рада") +". Будь здоров, приятель.";
			link.l1.go = "exit";
...
//============================ Испанская линейка, квест №6. перехватить вестового. =======================
        ...
        break;
  	 	case "Step_S6_3":
			dialog.text = "Хех, ну спасибо тебе, "+ GetSexPhrase("добрый человек","добрая госпожа") +". От денег не откажусь. А комнату можешь занимать хоть прямо сейчас, там открыто.";
			link.l1 = "Спасибо.";
			link.l1.go = "exit";
