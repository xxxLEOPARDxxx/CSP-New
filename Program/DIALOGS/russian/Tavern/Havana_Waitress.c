...
//========================== Исп. линейка, квест №4. Расследование убийства ==================================
 	 	case "Step_S4_1":
			dialog.text = "Нет, сеньор"+ GetSexPhrase("","ита") +", все в порядке.";
        ...
        break;
 	 	case "Step_S4_5":
			dialog.text = "Хорошо, сеньор"+ GetSexPhrase("","ита") +", я все скажу! Только пообещайте мне, что ничего плохого мне не сделаете.";
        ...
        break;
 	 	case "Step_S4_9":
			dialog.text = "Больше ничего, сеньор"+ GetSexPhrase("","ита") +". Этот человек забрал записку и ушел. А утром по городу разнеслась весть о том, что дон Хуан мертв. Вот тут-то я и догадалась, что к чему. Только никому не сказала, боялась, что меня причислят к соучастникам преступления. Сеньор"+ GetSexPhrase("","ита") +", вы обещали не делать мне ничего плохого. Прошу вас, сдержите свое слово!";
        ...
        break;
 	 	case "Step_S4_10":
			dialog.text = "Спасибо, сеньор"+ GetSexPhrase("","ита") +", да хранит вас Господь! Я очень сожалею, что так все вышло, но я ни в чем не виновата!";
