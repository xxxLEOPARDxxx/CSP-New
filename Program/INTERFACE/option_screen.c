...
void InitInterface(string iniName)
{
	...
	SetFormatedText("TEXT_NATIONS_PIC_SETTINGS", "»конки наций");
	SetFormatedText("TEXT_VISUAL_CIRASS_PIC_SETTINGS", "¬изуал кирас");
	SetFormatedText("TEXT_FONT_QUESTBOOK_PIC_SETTINGS", "Ўрифт журнала");
