// Warship. ƒоведенный до ума интерфейс бумажной карты из  3. “еперь это интерфейс отличной карты.
// espkk # ActiveMap 1.3 # 25/Sep/2017 - map with trade assistant for Sea Dogs: TEHO / “еперь действительно доведенный до ума =) 
