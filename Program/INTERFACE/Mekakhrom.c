...
void Type_1()
{
	...
	CreateString(true,"Type_1_RiddleHeader", "Загадка: ", FONT_CAPTION, COLOR_NORMAL, 400,158,SCRIPT_ALIGN_CENTER,1.0);
	
	string sString = PChar.Dozor.Riddle.Type_1.Question;
	SetFormatedText("RIDDLE_TEXT_1", sString);
	
	CreateString(true,"Type_1_Answer_1", "Место назначения:", FONT_CAPTION, COLOR_NORMAL, 130,360,SCRIPT_ALIGN_LEFT,1.0);
	CreateString(true,"Type_1_KeyPhrase", "Ответьте правильно для получения ключевой фразы.", FONT_CAPTION, COLOR_NORMAL, 410,400,SCRIPT_ALIGN_CENTER,0.9);
}
...
void Done_1()
{
	...
	if(sAnswer == sAnswerBase)
	{
		...
		CreateString(true,"Type_1_KeyPhrase", "Ключевая фраза: " + sKeyPhrase, FONT_CAPTION, argb(255,128,255,128), 410,400,SCRIPT_ALIGN_CENTER,0.9);
	...
	{
		CreateString(true,"Type_1_KeyPhrase", "Ответ неверный.", FONT_CAPTION, argb(255,255,128,128), 410,400,SCRIPT_ALIGN_CENTER,0.9);
		SetSelectable("TYPE_1_OK", false);
	}
}
...
void Type_2()
{
	...
	CreateString(true,"Type_2_RiddleHeader", "Загадка: ", FONT_CAPTION, COLOR_NORMAL, 400,158,SCRIPT_ALIGN_CENTER,1.0);
	
	string sString = PChar.Dozor.Riddle.Type_2.Question;
	SetFormatedText("RIDDLE_TEXT_2", sString);
	
	CreateString(true,"Type_2_Answer_1", "Остров:", FONT_CAPTION, COLOR_NORMAL, 215,320,SCRIPT_ALIGN_LEFT,1.0);
	CreateString(true,"Type_2_Answer_2", "Место назначения:", FONT_CAPTION, COLOR_NORMAL, 265,360,SCRIPT_ALIGN_RIGHT,1.0);
	CreateString(true,"Type_2_KeyPhrase", "Ответьте правильно для получения ключевой фразы.", FONT_CAPTION, COLOR_NORMAL, 410,400,SCRIPT_ALIGN_CENTER,0.9);
}
...
void Done_2()
{
	...
	if(sAnswer == sAnswerBase && sAnswer2 == sAnswerBase2)
	{
		...
		CreateString(true,"Type_2_KeyPhrase", "Ключевая фраза: " + sKeyPhrase, FONT_CAPTION, argb(255,128,255,128), 410,400,SCRIPT_ALIGN_CENTER,0.9);
	...
	{
		CreateString(true,"Type_2_KeyPhrase", "Ответ неверный.", FONT_CAPTION, argb(255,255,128,128), 410,400,SCRIPT_ALIGN_CENTER,0.9);
		SetSelectable("TYPE_2_OK", false);
	}
}
...
void Type_3()
{
	...
	CreateString(true,"Type_3_RiddleHeader", "Загадка: ", FONT_CAPTION, COLOR_NORMAL, 400,98,SCRIPT_ALIGN_CENTER,1.0);
	
	string sString = PChar.Dozor.Riddle.Type_3.Question;
	SetFormatedText("RIDDLE_TEXT_3", sString);
	
	CreateString(true,"Type_3_Answer_1", "Остров:", FONT_CAPTION, COLOR_NORMAL, 165,410,SCRIPT_ALIGN_LEFT,1.0);
	CreateString(true,"Type_3_Answer_2", "Здание:", FONT_CAPTION, COLOR_NORMAL, 215,450,SCRIPT_ALIGN_RIGHT,1.0);
	CreateString(true,"Type_3_KeyPhrase", "Ответьте правильно для получения ключевой фразы.", FONT_CAPTION, COLOR_NORMAL, 410,490,SCRIPT_ALIGN_CENTER,0.9);
}
...
void Done_3()
{
	...
	if(sAnswer == sAnswerBase && sAnswer2 == sAnswerBase2)
	{
		...
		CreateString(true,"Type_3_KeyPhrase", "Ключевая фраза: " + sKeyPhrase, FONT_CAPTION, argb(255,128,255,128), 410,490,SCRIPT_ALIGN_CENTER,0.9);
	...
	{
		CreateString(true,"Type_3_KeyPhrase", "Ответ неверный.", FONT_CAPTION, argb(255,255,128,128), 410,490,SCRIPT_ALIGN_CENTER,0.9);
		SetSelectable("TYPE_3_OK", false);
	}
}
...
void Type_4()
{
	...
	CreateString(true,"Type_4_RiddleHeader", "Загадка: ", FONT_CAPTION, COLOR_NORMAL, 400,98,SCRIPT_ALIGN_CENTER,1.0);
	...
	CreateString(true,"Type_4_Answer_1", "Пункт назначения:", FONT_CAPTION, COLOR_NORMAL, 165,410,SCRIPT_ALIGN_LEFT,1.0);
	CreateString(true,"Type_4_Answer_2", "Место:", FONT_CAPTION, COLOR_NORMAL, 295,450,SCRIPT_ALIGN_RIGHT,1.0);
	CreateString(true,"Type_4_Phrase_1", "Сегодня на площади из здания верфи был слышен крик:", FONT_NORMAL, COLOR_NORMAL, 410,355,SCRIPT_ALIGN_CENTER,0.9);
	CreateString(true,"Type_4_Phrase_2", "''Наконец-то я достроил этот корабль! Достроил!''", FONT_NORMAL, COLOR_NORMAL, 410,375,SCRIPT_ALIGN_CENTER,0.9);
}
...
void Type_7()
{
	...
	CreateString(true,"Type_7_RiddleHeader", "Загадка: ", FONT_CAPTION, COLOR_NORMAL, 400,98,SCRIPT_ALIGN_CENTER,1.0);
	
	string sString = PChar.Dozor.Riddle.Type_7.Question;
	SetFormatedText("RIDDLE_TEXT_7", sString);
	
	CreateString(true,"Type_7_Answer_1", "Остров:", FONT_CAPTION, COLOR_NORMAL, 165,410,SCRIPT_ALIGN_LEFT,1.0);
	CreateString(true,"Type_7_Answer_2", "Место:", FONT_CAPTION, COLOR_NORMAL, 215,450,SCRIPT_ALIGN_RIGHT,1.0);
	CreateString(true,"Type_7_KeyPhrase", "Ответьте правильно для получения ключевой фразы.", FONT_CAPTION, COLOR_NORMAL, 390,490,SCRIPT_ALIGN_CENTER,0.9);
}
...
void Type_8()
{
	...
	CreateString(true,"Type_8_RiddleHeader", "Загадка: ", FONT_CAPTION, COLOR_NORMAL, 400,108,SCRIPT_ALIGN_CENTER,1.0);
