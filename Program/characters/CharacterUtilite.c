...
bool IsPCharHaveMushketerModel()
{
	...
	if(HasSubStr(sModel, "Blad") || HasSubStr(sModel, "PGG_Black") || HasSubStr(sModel, "PGG_Benito") || HasSubStr(sModel, "PGG_Sharp") || HasSubStr(sModel, "PGG_PeBlad") || HasSubStr(sModel, "PGG_Montoia") || HasSubStr(sModel, "Pat") || HasSubStr(sModel, "Resc") || HasSubStr(sModel, "Port") || HasSubStr(sModel, "PGG_ShMor") || HasSubStr(sModel, "PGG_ShBerg") || HasSubStr(sModel, "PGG_Devlin") || HasSubStr(sModel, "PGG_Uof") || HasSubStr(sModel, "PGG_Alonso") || HasSubStr(sModel, "PGG_Archy") || HasSubStr(sModel, "PGG_Chard") || HasSubStr(sModel, "PGG_Isterling") || HasSubStr(sModel, "PGG_Barrows") || HasSubStr(sModel, "PGG_Pitt") || HasSubStr(sModel, "PGG_Claude_Durand") || HasSubStr(sModel, "PGG_DeLuck") || HasSubStr(sModel, "PGG_Fox") || HasSubStr(sModel, "PGG_Hugh") || HasSubStr(sModel, "PGG_Alex_blade") || HasSubStr(sModel, "PGG_HuanTubercul") || HasSubStr(sModel, "PGG_Doggerty") || HasSubStr(sModel, "PGG_Fleetwood") || HasSubStr(sModel, "PGG_Longway") || HasSubStr(sModel, "PGG_Black") || HasSubStr(sModel, "PGG_Yohang") || HasSubStr(sModel, "PGG_Tich") || HasSubStr(sModel, "PGG_Tibo") || HasSubStr(sModel, "PGG_Hero") || HasSubStr(sModel, "PGG_Blad_vorob") || HasSubStr(sModel, "PGG_Ballantre") || HasSubStr(sModel, "PGG_Dartanian") || HasSubStr(sModel, "PGG_Enrique") || HasSubStr(sModel, "PGG_Espinosa"))
	{
		return true;
	}
