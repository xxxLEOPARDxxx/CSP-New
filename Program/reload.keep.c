...
int Reload(aref reload_group, string locator_name, string current_location)
{
	...
	if(reload_island_index >= 0)
	{
		...
		{
			SendMessage(&reload_fader, "ls",FADER_PICTURE,"loading\cabine.tga.tx");
		}
	}
	else
	{
			...
			if(CheckAttribute(&Locations[loc_pict_index],"image"))
			{
				...
				else
				{
					...
					switch(1+rand(GetAttributesNum(LoadingScreens)-1))
					{
						...
						case 6: LoadingImage = Locations[loc_pict_index].image.6; break;
						case 7: LoadingImage = Locations[loc_pict_index].image.7; break;
						case 8: LoadingImage = Locations[loc_pict_index].image.8; break;
						case 9: LoadingImage = Locations[loc_pict_index].image.9; break;
						case 10: LoadingImage = Locations[loc_pict_index].image.10; break;
						case 11: LoadingImage = Locations[loc_pict_index].image.11; break;
						case 12: LoadingImage = Locations[loc_pict_index].image.12; break;
						case 13: LoadingImage = Locations[loc_pict_index].image.13; break;					
						case 14: LoadingImage = Locations[loc_pict_index].image.14; break;
						case 15: LoadingImage = Locations[loc_pict_index].image.15; break;
